...
SET [PERCENTUAL DE COMISSAO] = '1.1' * [PERCENTUAL DE COMISSAO]
...
WHERE MATRICULA = 00233
      OR [PERCENTUAL DE COMISSAO] > 0.09 
...
SELECT *
FROM [TABELA DE CLIENTES]
WHERE YEAR([DATA DE NASCIMENTO]) = 1996 
...
SELECT *
FROM [TABELA DE CLIENTES]
WHERE DAY([DATA DE NASCIMENTO]) = 20 


-- Seleciona os clientes que nasceram dia 29 E moram na Tijuca
SELECT *
FROM [TABELA DE CLIENTES]
WHERE DAY([DATA DE NASCIMENTO]) = 29
      AND BAIRRO = 'Tijuca' 
