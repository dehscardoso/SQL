...
SELECT BAIRRO, SUM([LIMITE DE CREDITO]) AS 'Limite de Crédito Total' FROM [TABELA DE CLIENTES] 
...
SELECT BAIRRO, ESTADO, SUM([LIMITE DE CREDITO]) AS 'Limite de Crédito Total' FROM [TABELA DE CLIENTES] 
